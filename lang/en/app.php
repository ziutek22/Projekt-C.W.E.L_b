...
return [
    ...
    'dashboard' => [
        ...
        'in_progress_vulnerabilities' => 'Vulnerabilities in progress',
        'unassigned_vulnerabilities' => 'Unassigned',
        'quick_add_vulnerability' => 'Add vulnerability',
        'quick_add_asset' => 'Add asset',
        'recent_vulnerabilities' => 'Recent Vulnerabilities',
        'active_alerts' => 'Active alerts',
        'no_active_alerts' => 'No critical open vulnerabilities.',
        'no_cve' => 'No CVE ID',
        'view_all' => 'View all',
